...
class VenueDetailsScreen extends StatelessWidget {
  ...
  const VenueDetailsScreen({super.key, @PathParam('venueId') required this.venueId});

  @override
  Widget build(BuildContext context) {
    return BlocProvider(
      create: (context) => VenueDetailsBloc(context.read(), venueId: venueId)..add(const VenueDetailsEvent.started()),
