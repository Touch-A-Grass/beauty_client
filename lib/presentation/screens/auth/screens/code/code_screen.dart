...
import 'package:beauty_client/core/constants.dart';
                        ...
                        children: [
                          AnimatedBuilder(
                            ...
                            builder: (context, _) => TextButton(
                              onPressed: timeToResend.value.inSeconds > 0 || widget.isLoading
                                  ? null
                                  : () {
                                      context.read<AuthBloc>().add(const AuthEvent.resendCodeRequested());
                                    },
                              child: timeToResend.value.inSeconds > 0
                                  ? Text(S.of(context).telegramResendInMessage(timeToResend.value.inSeconds.toString()))
