...
import 'package:beauty_client/features/chat/presentation/components/unread_badge_container.dart';
...
class _OrderListItemState extends State<OrderListItem> {
  ...
  Widget build(BuildContext context) {
    return UnreadBadgeContainer(
      count: widget.order.unreadMessageCount,
      child: DecoratedBox(
